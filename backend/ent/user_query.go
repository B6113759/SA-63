...
func (uq *UserQuery) QueryDeceasedreceives() *DeceasedReceiveQuery {
	query := &DeceasedReceiveQuery{config: uq.config}
...
func (uq *UserQuery) WithDeceasedreceives(opts ...func(*DeceasedReceiveQuery)) *UserQuery {
	query := &DeceasedReceiveQuery{config: uq.config}
	for _, opt := range opts {
		opt(query)
	}
	uq.withDeceasedreceives = query
	return uq
}
...
func (uq *UserQuery) sqlAll(ctx context.Context) ([]*User, error) {
	...
	if query := uq.withDeceasedreceives; query != nil {
		...
		query.Where(predicate.DeceasedReceive(func(s *sql.Selector) {
			s.Where(sql.InValues(user.DeceasedreceivesColumn, fks...))
		}))
