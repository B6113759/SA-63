...
func (e UserEdges) DeceasedreceivesOrErr() ([]*DeceasedReceive, error) {
	if e.loadedTypes[0] {
...
// QueryDeceasedreceives queries the deceasedreceives edge of the User.
func (u *User) QueryDeceasedreceives() *DeceasedReceiveQuery {
	return (&UserClient{config: u.config}).QueryDeceasedreceives(u)
}
