...
func HasDeceasedreceives() predicate.Patient {
	return predicate.Patient(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(DeceasedreceivesTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2O, false, DeceasedreceivesTable, DeceasedreceivesColumn),
		)
...
func HasDeceasedreceivesWith(preds ...predicate.DeceasedReceive) predicate.Patient {
	return predicate.Patient(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
